...
function salvar () {
    ...
    let data_inicio = document.querySelector('input[name="data_inicio"]').value.split('-');
    let data_fim = document.querySelector('input[name="data_fim"]').value.split('-');
...
function atualizar () {
	...
	let data_inicio = document.querySelector('input[name="edit_data_inicio"]').value.split('-');
	let data_fim = document.querySelector('input[name="edit_data_fim"]').value.split('-');
	data_inicio = `${data_inicio[2]}/${data_inicio[1]}/${data_inicio[0]}`;
	data_fim = `${data_fim[2]}/${data_fim[1]}/${data_fim[0]}`;
